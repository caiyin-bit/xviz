...
node bin/xviz.mjs render -c examples/tree.json       -o "$OUT/tree.png"
node bin/xviz.mjs render -c examples/graph.json      -o "$OUT/graph.png"

# v0.6.0 additions (M3 of Superset parity roadmap)
