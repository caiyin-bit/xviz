  ...
  interface Window {
    __CHART__?: {
      type: 'pie' | 'bar' | 'line' | 'table' | 'big-number' |
            'scatter' | 'heatmap' | 'sankey' | 'funnel' | 'gauge' | 'boxplot' | 'histogram' | 'treemap' | 'sunburst' | 'radar' | 'waterfall' | 'step' | 'tree' | 'graph' | 'timeseries-bar' | 'timeseries-line' | 'mixed-timeseries' | 'gantt'
      width: number
      height: number
